...
CREATE TABLE `daily_closings` (
  `closing_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT (uuid()),
  `date` date NOT NULL,
  `staff_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ten_thousand_count` int DEFAULT '0' COMMENT '1万円札の枚数',
  `ten_thousand_count_after` int DEFAULT '0' COMMENT '締め後1万円札の枚数',
  `five_thousand_count` int DEFAULT '0' COMMENT '5千円札の枚数',
  `five_thousand_count_after` int DEFAULT '0' COMMENT '締め後5千円札の枚数',
  `two_thousand_count` int DEFAULT '0' COMMENT '2千円札の枚数',
  `two_thousand_count_after` int DEFAULT '0' COMMENT '締め後2千円札の枚数',
  `one_thousand_count` int DEFAULT '0' COMMENT '千円札の枚数',
  `one_thousand_count_after` int DEFAULT '0' COMMENT '締め後千円札の枚数',
  `five_hundred_count` int DEFAULT '0' COMMENT '500円玉の枚数',
  `five_hundred_count_after` int DEFAULT '0' COMMENT '締め後500円玉の枚数',
  `one_hundred_count` int DEFAULT '0' COMMENT '100円玉の枚数',
  `one_hundred_count_after` int DEFAULT '0' COMMENT '締め後100円玉の枚数',
  `fifty_count` int DEFAULT '0' COMMENT '50円玉の枚数',
  `fifty_count_after` int DEFAULT '0' COMMENT '締め後50円玉の枚数',
  `ten_count` int DEFAULT '0' COMMENT '10円玉の枚数',
  `ten_count_after` int DEFAULT '0' COMMENT '締め後10円玉の枚数',
  `five_count` int DEFAULT '0' COMMENT '5円玉の枚数',
  `five_count_after` int DEFAULT '0' COMMENT '締め後5円玉の枚数',
  `one_count` int DEFAULT '0' COMMENT '1円玉の枚数',
  `one_count_after` int DEFAULT '0' COMMENT '締め後1円玉の枚数',
  `actual_cash` int DEFAULT '0' COMMENT '実際在高',
  `total_sales` int NOT NULL,
  `cash_sales` int DEFAULT '0',
  `expected_cash` int DEFAULT '0' COMMENT '理論上の現金額',
  `discrepancy` int DEFAULT '0' COMMENT '過不足',
  `record_amount` int DEFAULT '0' COMMENT '登録額（現金-規定額-支払い）',
  `expected_card` int DEFAULT '0' COMMENT '理論上のカード額',
  `transaction_count` int DEFAULT '0' COMMENT '取引件数',
  `fixed_amount` int DEFAULT '50000' COMMENT 'レジ規定額',
  `payments` json DEFAULT NULL COMMENT '支払い明細（JSON）',
  `total_payments` int DEFAULT '0' COMMENT '支払い合計',
  ...
  `notes` text COLLATE utf8mb4_unicode_ci,
  `reconciliation_notes` text COLLATE utf8mb4_unicode_ci COMMENT '照合メモ',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`closing_id`),
  UNIQUE KEY `unique_date` (`date`),
  KEY `staff_id` (`staff_id`),
  KEY `idx_date` (`date`),
  CONSTRAINT `daily_closings_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`staff_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
